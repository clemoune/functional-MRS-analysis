...
function [Matrix_Vox_Spectro_EPI] = Spectro_Vox_EPI_dirinv(directory_EPI,directory_spectro)
...
image_EPI_db=double(image_EPI(:,:,1,1,spectro_center_matrix(3)));
imagesc(rot90((image_EPI_db + image_EPI_db.*Matrix_Vox_Spectro_EPI(:,:,spectro_center_matrix(3))),1))
end
% 
